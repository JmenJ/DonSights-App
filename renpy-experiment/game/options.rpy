...
define config.name = _("DonSightsApp")

#define config.android_api = 33  # Android 14 (стабильный)
#define config.min_android_api = 21  # Минимальная версия (Android 5.0)
...
define build.name = "DonSightsApp"
...
define config.save_directory = "DonSightsApp-1761131043"
